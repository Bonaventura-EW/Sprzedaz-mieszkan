...
<svg width="40" height="40" viewBox="0 0 64 64" aria-hidden="true">
  ...
  <circle cx="32" cy="32" r="29.5" fill="none" stroke="#a78bfa" stroke-width="1" opacity="0.55"/>
  <circle cx="32" cy="32" r="22" fill="none" stroke="#a78bfa" stroke-width="0.4" opacity="0.25"/>

  <!-- blok mieszkalny: bryła z oknami -->
  <g mask="url(#lgMask)">
    <rect x="22" y="17" width="20" height="30" rx="1.5" fill="#a78bfa" opacity="0.10"/>
    <rect x="22" y="17" width="20" height="30" rx="1.5" fill="none"
          stroke="#a78bfa" stroke-width="1.7"/>
